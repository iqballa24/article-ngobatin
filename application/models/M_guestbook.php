...
class M_guestbook extends CI_Model {
	...
	var $table = array('tb_guestbook');

	//field yang ditampilkan
	var $column_order = array(null,'nama', 'nim', 'email','date');

	//field yang diizin untuk pencarian 
	var $column_search = array('id','nama', 'nim', 'email','date');
	...
	public function insert($input)
	{
		...
		return $this->db->insert('tb_guestbook', $input);
	}
}